...
var handler = async (event) => {
  ...
  try {
    const decodedBody = event.isBase64Encoded ? Buffer.from(event.body, "base64") : event.body;
    const s3 = new AWS.S3();
    ...
    const params = {
      ...
      // Do not set ContentEncoding unless you're uploading the base64 string itself
    };
